...
# HIDL
PRODUCT_COPY_FILES += \
    device/wt88047_64/manifest.xml:system/vendor/manifest.xml
...
$(call inherit-product, device/wt88047_64/common64.mk)
...
# MSM8916 Headers
PRODUCT_VENDOR_KERNEL_HEADERS := hardware/qcom/msm8x09/kernel-header
...
PRODUCT_COPY_FILES += \
    ...
    device/wt88047_64/WCNSS_cfg.dat:system/etc/firmware/wlan/prima/WCNSS_cfg.dat \
